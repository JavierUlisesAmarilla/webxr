...
import {floatStrTrim} from '../../utils/common.jsx'
import {Config} from './config.jsx'
import {DIM_INCH, DIM_FEET, DIM_METER, DIM_CENTIMETER, DIM_MILLIMETER} from '../../utils/constants'
...
export class Dimension {
  ...
  static realFromMeasure(measure, unit) {
    if (!unit) {
      unit = Config.getStringValue('dimUnit')
    }
